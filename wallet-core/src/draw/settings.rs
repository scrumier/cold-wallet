...
use crate::layout::{SCREEN_W, SETTINGS_BTN_X, SETTINGS_BTN_W, SETTINGS_BTN_H,
                    SETTINGS_Y0, SETTINGS_Y1, SETTINGS_Y2, SETTINGS_Y3,
    ...
    D: DrawTarget<Color = Rgb565>,
{
    ...
    draw_button(display, SETTINGS_BTN_X, SETTINGS_Y2, SETTINGS_BTN_W, SETTINGS_BTN_H, "Descriptor",    white_stroke(2), white_text())?;
    draw_button(display, SETTINGS_BTN_X, SETTINGS_Y3, SETTINGS_BTN_W, SETTINGS_BTN_H, "About",         white_stroke(2), white_text())?;
